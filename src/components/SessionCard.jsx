    ...
    <div className="ticket_card">
      <div className="ticket_top">
        ...
        <div className="ticket_desc">
          ...
          {(() => {
            if (type === TariffType.PREFERENTIAL) {
              return (
                  <div className="ticket_desc_txt">
                    <div className="ticket_block">
                      <b>Студенты</b>
                      <span>(по студенческому билету)</span>
                    </div>
                    <div className="ticket_block">
                      <b>Многодетные семьи</b>
                      <span>(по удостоверению многодетной семьи)</span>
                    </div>
                    <div className="ticket_block">
                      <b>Пенсионеры</b>
                      <span>(по пенсионному удостоверению)</span>
                    </div>
                    <div className="ticket_block">
                      <b>Инвалиды (2-3 группы)</b>
                      <span>(по удостоверению)</span>
                    </div>
                  </div>
              )
            }
